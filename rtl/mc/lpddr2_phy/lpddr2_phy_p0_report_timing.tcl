...
foreach inst $instances {
	...
	set fitter_run [lpddr2_phy_p0_get_io_interface_type [lindex [lindex $pins(q_groups) 0] 0]]
	if {$fitter_run == ""} {
	...
	foreach opc $opcs {
		...
		lpddr2_phy_p0_perform_ac_analyses  $opcs $opcname $inst $family scale_factors pins t summary IP		
