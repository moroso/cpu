...
// 
// Generated using ACDS version 13.1 182 at 2014.05.18.18:12:17

`timescale 1 ps / 1 ps
module lpddr2_phy_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (14336),
		.INIT_FILE        ("lpddr2_phy_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	lpddr2_phy_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	lpddr2_phy_s0_mm_interconnect_1 mm_interconnect_1 (
		.avl_clk_out_clk_clk                             (avl_clk),                                                   //                           avl_clk_out_clk.clk
	...
	lpddr2_phy_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
